...
<head>
    ...
    <script>
        ...
        function userTyping() {
            ...
            $.post('functions/user_typing.php', {
                rec_id: rec_id
            },
            function(data){
                $('#typingResult').html(data);
            });            
        }
...
?>
    ...
    <div class="container">
            ...
            <div class="col-md-12" style="position: fixed; left: 0; bottom: 10px; width: 100%; text-align: center; margin-top: 4px; ">
                 <div class="col-md-12" style="padding-left: 50px; padding-right: 50px
                    ...
                    <form method="post" id="chatForm">
                       <textarea class="form-control" name="message" id="message" rows="1" style="width: 100%;" onfocus="userTyping()" onblur="clear()"></textarea>
        ...
        <!--<div class="row">-->
        <!--    <div class="col-md-12 col-sm-12" style="position: fixed; bottom: 10px;">-->
        <!--        <form method="post" id="chatForm">-->
